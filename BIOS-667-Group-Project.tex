...
\multicolumn{6}{l}{\rule{0pt}{1em}\textsuperscript{2} BotB = botulinum toxin type B;TWSTRS = Toronto Western Spasmodic Torticollis Rating Scale.}\\
\multicolumn{6}{l}{\rule{0pt}{1em}\textsuperscript{3} Pearson's Chi-squared test; Kruskal-Wallis rank sum test}\\
\end{longtable}
