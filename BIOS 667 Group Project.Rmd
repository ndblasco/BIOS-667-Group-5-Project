...
Excluding influential observations resulted in modest shifts in the parameter estimates and slightly improved precision. Notably, the effect of sex remained statistically significant. The treatment effect of 10,000 U at baseline also became stronger and statistically significant while the interaction coeffecients shrunk closer to 0. The influential points likely exerted disproportionate leverage because they represented observations with either unusually high fitted values, extreme covariate patterns, or large residuals relative to the rest of the sample. After removing these points, the overall interpretation of the model remained consistent, indicating that the main associations were not driven by these atypical observations. 
