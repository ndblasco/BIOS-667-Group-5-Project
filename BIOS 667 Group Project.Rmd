...
ggplot(data = cdystonia, aes(x = twstrs)) +
          geom_histogram(binwidth = 5, fill = "lightblue", color = "black") +
          facet_wrap(~ week) + ggtitle("Histograms of TWSTRS scores by week")
